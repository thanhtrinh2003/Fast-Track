...
const Store = () => {
  ...
  return (
    <View>
      ...
      <View style={{flexDirection: "row", justifyContent: "center", borderWidth: 1, width: "80%", alignSelf: "center", borderRadius: 10}}>
        <View style={{margin: 5}}>
      ...
      <View style={{flexDirection: "row", justifyContent: "center", borderWidth: 1, width: "80%", alignSelf: "center", backgroundColor: "lightgrey", borderRadius: 10}}>
        <View>
      ...
      <Text style={{textAlign: "right", marginRight: "10%", fontSize: 10, marginTop: 5}}>
